/**
 * This file holds the functionality for the Larson fragment.
...
class LarsonFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_larson, container, false)
        ...
        favoriteButton.setOnClickListener {
            val larsonImage = ResidenceImage(
                id = R.drawable.larson,
